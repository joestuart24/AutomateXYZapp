  ...
  return (
    <div className="flex flex-col md:flex-row justify-center items-center md:items-start gap-3">
      ...
      <div className="flex flex-col justify-center items-center md:items-start gap-1">
        ...
        {/* lassName="font-semibold text-base-content">32</span> businesses
          automate their workflows with us - this covers the number of clients. we can eventually link to table for client count */}
        <div className="text-base text-base-content/80">
          <span className="font-semibold text-base-content"></span>Businesses
          trust us to streamline their workflows and enhance efficiency
        </div>
      </div>
    </div>
  );
